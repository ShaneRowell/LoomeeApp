  ...
  Widget _buildWelcomePage() {
    return Padding(
      ...
      child: Column(
        children: [
          const Spacer(flex: 2),
          // Brand hero — fontSize 40 >= 20, KEEP playfairDisplay
          Text(
            'Welcome\nto Loomeé',
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                // Permission card description — rule 2
                Text(
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          const Spacer(),
          // Screen hero — fontSize 32 >= 20, KEEP playfairDisplay
          Text(
            'All Set!',
            style: GoogleFonts.playfairDisplay(
              fontSize: 32,
